...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-02-2017 a las 21:11:57
...
CREATE TABLE `bien` (
  ...
  `fec_bien` datetime NOT NULL,
  `can_bien` int(11) NOT NULL,
  `val_bien` decimal(6,2) NOT NULL,
  `fot_bien` varchar(400) NOT NULL,
  `reg_bien` int(11) NOT NULL,
  `est_bien` char(1) NOT NULL
...
CREATE TABLE `usuario` (
  ...
  `est_user` char(1) COLLATE utf8_spanish_ci NOT NULL,
...
(1, '47793150', 'mario', 'choquetaipe asto', '983799107', 'av:sol', 'mario125', 'm123', 'CONTRATADO', '1', '');
